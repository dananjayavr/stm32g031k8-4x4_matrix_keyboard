...
/* Private defines -----------------------------------------------------------*/
#define KB_LED_4_Pin GPIO_PIN_9
#define KB_LED_4_GPIO_Port GPIOB
#define T_NRST_Pin GPIO_PIN_2
#define T_NRST_GPIO_Port GPIOF
#define KB_LED_2_Pin GPIO_PIN_0
#define KB_LED_2_GPIO_Port GPIOA
...
#define KB_LED_1_Pin GPIO_PIN_4
#define KB_LED_1_GPIO_Port GPIOB
#define KB_LED_3_Pin GPIO_PIN_5
#define KB_LED_3_GPIO_Port GPIOB
